...
import time
os.chdir('/Users/samankhan/Documents/capstone_project/Github_project/generate_ai_room_designs/')
...
objects_extraction_dir = './data/anas/'
...
def generate_caption(image_path):
    ...
    generation_args = {
    "max_length": 100,  # Maximum length of the caption
...
for root, dirs, files in os.walk(objects_extraction_dir):
    with alive_bar(len(os.listdir(files))) as bar:
        for file in files:
...
# annotations_file_path = os.path.join(annotation_path, 'annotations.json')
